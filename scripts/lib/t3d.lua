--[[
    ...
    Library to make true 3d flat-shaded triangle graphics.
...
t3d.translateTs = generateTransformTs(translate3)
t3d.scaleTs = generateTransformTs(scale3)
t3d.rotateTs = generateTransformTs(rotate3)

function t3d.cloneTs(ts)
  local newTs = {}
  for i = 1, #ts do
    local newT = {}
    for j = 1, 10 do
